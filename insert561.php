...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $query = "INSERT INTO `research5.6.1` (ID, no_non_discrimination, no_ppa_implemented, no_art_humanities, title_ppa, description_ppa, total_cost, fund_source  ) VALUES ('$ID', '$no_non_discrimination', '$no_ppa_implemented', '$title_ppa', '$description_ppa', '$total_cost', '$fund_source')";
