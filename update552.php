...
<div class=" w-100 h-auto" id="research552" style="display: block;">
                        <h2 class="text-center pb-4"> Proportion of applicants for graduation to total number of 
graduates
</h2>
                        <form action="" method="post">
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
                                <input type="text" class="form-control" placeholder="Total number of students starting a degree" name="applicants_for_graduation" value="<?php echo "$applicants_for_graduation"?>">
                            </div>
                            <div class="d-grid">
