...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        $no_policy_protecting = $_POST['no_policy_protecting'];
        ...
        $update_query = "UPDATE `research5.6.9`
        SET no_policy_protecting = '$no_policy_protecting', no_ppa_implemented = '$no_ppa_implemented', title_ppa = '$title_ppa', description_ppa = '$description_ppa', total_cost = '$total_cost', fund_source = '$fund_source'
        WHERE id = $id";
    ...
    $sql = "SELECT * FROM `research5.6.9` WHERE ID = '$id'";
...
?>
<div class=" w-100 h-auto" id="research569" style="display: block;">
                        <h2 class="text-center pb-4">Policies protecting those reporting discrimination</h2>
                        <form action="" method="post">
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
                                <input type="text" class="form-control" placeholder="Total number of students starting a degree" name="no_policy_protecting" value="<?php echo "$no_policy_protecting"?>">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
