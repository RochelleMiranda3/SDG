...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        SET no_non_discrimination = '$no_non_discrimination', no_ppa_implemented = '$no_ppa_implemented', no_art_humanities = '$no_art_humanities', title_ppa = '$title_ppa', description_ppa = '$description_ppa', total_cost = '$total_cost', fund_source = '$fund_source'
        WHERE id = $id";
...
<div class=" w-100 h-auto" id="research561" style="display: block;">
                        <h2 class="text-center pb-4">researchchangetitle</h2>
                        <form action="" method="post">
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
                                <input type="text" class="form-control" placeholder="Total number of students starting a degree" name="no_non_discrimination" value="<?php echo "$no_non_discrimination"?>">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
                                <input type="text" class="form-control" placeholder="Total number of first-generation students starting a degree" name="no_art_humanities" value="<?php echo "$no_art_humanities"?>">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class=""></i></span>
